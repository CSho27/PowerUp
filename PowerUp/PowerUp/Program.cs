...
namespace PowerUp
{
  class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      var draftPoolGenerator = new DraftPoolGenerator(mlbLookupServiceClient, playerGenerator);
      draftPoolGenerator.GenerateDraftPool(lsStatsAlgorithm).GetAwaiter().GetResult();
    }
