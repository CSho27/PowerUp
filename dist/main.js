...
var connection = new ConnectionBuilder().connectTo("dotnet", "run", "--project", "./PowerUp/PowerUp").build();
...
function pingDotNet() {
  setTimeout(function () {
    connection.send("greeting", "Mom", function (response, err) {
      console.log(err === null || err === void 0 ? void 0 : err.Message);
      console.log(response);
      if (!response) pingDotNet();
    });
  }, 1000);
}
